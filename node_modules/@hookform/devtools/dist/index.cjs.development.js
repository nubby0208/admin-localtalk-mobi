...
function PanelChildren(_a) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null, Object.entries(fields)
        .filter(function (_a) {
        var name = _a[0];
        return ((name &&
            name.toLowerCase &&
...
var Panel = function (_a) {
    ...
    return (React__namespace.createElement("div", { style: {
        ...
        React__namespace.createElement("div", { style: {
            ...
            React__namespace.createElement(PanelChildren, { fields: fieldsRef.current, searchTerm: searchTerm, errors: errors, touchedFields: touchedFields, dirtyFields: dirtyFields, fieldsValues: fieldsValues, state: state })),
...
var DevTool = function (props) {
    ...
    return (React__namespace.createElement(littleStateMachine.StateMachineProvider, null,
        React__namespace.createElement(DevToolUI, { control: (props && props.control) || methods.control, placement: (_a = props === null || props === void 0 ? void 0 : props.placement) !== null && _a !== void 0 ? _a : 'top-left' })));
};
